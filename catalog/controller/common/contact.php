...
/*		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/contact.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/contact.tpl', $data);
		} else {
			return $this->load->view('default/template/common/contact.tpl', $data);
		}
*/
	}
...
*/
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/success.tpl')) {
			...
			return $this->load->view('default/template/common/success.tpl', $data);
		}
