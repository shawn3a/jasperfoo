                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-11">
                            <input type="text" name="captcha" id="input-captcha" class="form-control"
                                   placeholder="<?php echo $entry_captcha; ?>"/>
                        </div>
                    </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="panel-default">
                <div class="panel-body" id="contact_details">
                    ...
                    <div class="row">
                        <div class="col-sm-12"><img src="http://demo.jasperfoo.co.nz/image/contact_logo.png"
                    ...
                    <div class="row">
                        <div class="col-sm-12"><h4><span style="color:#F0F0F0;"><b>M:</b>  <?php echo $telephone; ?></span>
                            </h4>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-collapse collapse" id="collapse-location<?php echo $location['location_id']; ?>">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <img src="http://demo.jasperfoo.co.nz/image/contact_logo.png" title="" alt=""
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <strong><?php echo $text_telephone; ?></strong><?php echo $location['telephone']; ?>
                                <br/>
                            </div>
                        </div>
